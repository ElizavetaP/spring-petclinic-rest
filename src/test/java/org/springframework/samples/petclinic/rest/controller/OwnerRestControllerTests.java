...
import static org.springframework.samples.petclinic.utils.TestDataUtils.setWeightUniversal;
...
class OwnerRestControllerTests {
    ...
    void initOwners() {
        ...
        pet.id(3)
            ...
            .type(petType);
        setWeightUniversal(pet, 15.75);   // теперь безопасно для любого DTO
        pets.add(pet);
    ...
    void testUpdateOwnersPetSuccess() throws Exception {
        ...
        setWeightUniversal(updatedPetDto, 25.0);
